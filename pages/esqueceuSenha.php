...
<body>
    <main class="d-flex align-items-center justify-content-center m-0">
        <div class="login-box">
            ...
            <p class="sub-text">Insira seu email abaixo para receber instruções sobre como redefinir sua senha.</p>
            <form method="POST" action="send_reset_email.php">
                <div class="input-box">
                    ...
                    <p class="sub-text">Voltar para <a class="link" href="index.php">Login</a></p>
                </div>
            </form>
        </div>
    </main>
